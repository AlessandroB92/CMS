        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item"> <a class="nav-link <?= $indexActive ?>" aria-current="page" href='<?= $indexPage ?>'><i class="fa-solid fa-users fa-xs"></i> Users</a> </li>
                    <li class="nav-item"> <a class="nav-link <?= $newActive ?>" href='<?= $indexPage ?>?action=insert'><i class="fa-solid fa-user-plus fa-xs"></i> New User</a> </li>
